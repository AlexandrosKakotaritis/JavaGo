...
public class GoTUI {
    ...
    private void getHelp() {
        ...
        String helpText = """
                AI players: \s
                    ...
                    Use -S instead of name for the Smart Strategy AI\s
                    \s
                How to play: \s
    ...
    private void displayWinner(boolean quit) {
        if (quit){
            ...
            if (winner == null) {
                ...
                System.out.println("Winner is: " + ((AbstractPlayer) winner).getName()
                                           + " GG!");
            }
        }
    }
    ...
    private String getQuitMessage() {
        ...
        if (game.getTurn().equals(player1)) {
            message = (((AbstractPlayer) player1).getName())
                    + " forfeited the match. " + (((AbstractPlayer) player2).getName())
                    + " wins";
        }
        else{
            message =  (((AbstractPlayer) player2).getName())
                    + " forfeited the match. " + (((AbstractPlayer) player1).getName())
                    + " wins";
        }
        return message;
    }
